...
class ModelID:
    ...
    LORENTZ_1D = 13
    LORENTZ_1D_DOUBLE = 14
    LORENTZ_1D_OCT = 15
    LORENTZ_1D_TRIPLE = 16
    LORENTZ_1D_QUAD = 17
    GAUSS_1D_DOUBLE = 18
    LORENTZ_1D_OCT_SINGLE_OFFSET = 19
    LORENTZ_1D_DOUBLE_SINGLE_OFFSET = 20
    DOUBLE_EXPONENTIAL_DECAY_1D = 21
    SINGLE_EXPONENTIAL_DECAY_1D = 22
